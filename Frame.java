...
public class Frame extends JFrame {
    ...
    stopMusic();
    this.remove(screen); // Remove the screen if it's currently displayed
    this.add(mainMenu); // Add the main menu panel
    this.revalidate(); // Revalidate the frame to reflect the changes
    this.repaint(); // Repaint the frame to update the display
    }
}
